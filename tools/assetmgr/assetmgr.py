...
def require_reference_format():
    if os.environ.get('ALLOW_PD_ASSET_FORMATS') != '1':
        raise SystemExit(
            'This generator uses Perfect Dark-style asset formats, not '
            'Conker formats. See tools/assetmgr/README.md. Set '
            'ALLOW_PD_ASSET_FORMATS=1 only for reference-format research.'
        )
