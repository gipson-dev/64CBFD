...
34-word `func_151D74B0` after completing `func_1502EA0C` through guarded
...
recovery, and `func_151581D8` through guarded prologue and argument
scheduling. The latest result is in
