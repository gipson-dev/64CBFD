...
12-word `func_151318E8` after completing `func_1502EA0C` through guarded
...
lifetimes, and `func_150DE2C4` through source-level short-circuit control
flow. The latest result is in
