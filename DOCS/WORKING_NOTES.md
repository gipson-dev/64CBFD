...
19-word `func_150DE2C4` after completing `func_1502EA0C` through guarded
...
cursor expansions, and `func_150CF578` through source-level scalar/product
lifetimes. The result is in
