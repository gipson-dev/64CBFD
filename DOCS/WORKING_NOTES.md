...
19-word `func_151581D8` after completing `func_1502EA0C` through guarded
...
normalization, and `func_15133E3C` through aggregate-copy and pointer-ABI
recovery. The latest result is in
