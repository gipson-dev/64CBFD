...
| --- | ---: | ---: | ---: |
| Total | `[###########-------------]` 2,551 / 5,490 (46.47%) | 1 | 2,938 |
| Init | `[##################------]` 387 / 508 (76.18%) | 1 | 120 |
| Game | `[##########--------------]` 1,983 / 4,801 (41.30%) | 0 | 2,818 |
...
The exact count is twenty-two above the July snapshot. The higher percentage is still
primarily caused by the smaller C denominator; focused event-swap and debugger
passes have added twenty-four exact functions after the restoration baseline. See
