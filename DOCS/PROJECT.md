...
The exact count is ten above the July snapshot. The higher percentage is still
primarily caused by the smaller C denominator; focused event-swap and debugger
passes have added twelve exact functions after the restoration baseline. See
