...
| --- | ---: | ---: | ---: |
| Total | `[###########-------------]` 2,552 / 5,490 (46.48%) | 1 | 2,937 |
| Init | `[##################------]` 387 / 508 (76.18%) | 1 | 120 |
| Game | `[##########--------------]` 1,984 / 4,801 (41.32%) | 0 | 2,817 |
...
The exact count is twenty-three above the July snapshot. The higher percentage is still
primarily caused by the smaller C denominator; focused event-swap and debugger
passes have added twenty-five exact functions after the restoration baseline. See
