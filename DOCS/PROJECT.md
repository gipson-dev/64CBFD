...
| --- | ---: | ---: | ---: |
| Total | `[###########-------------]` 2,567 / 5,488 (46.77%) | 1 | 2,920 |
| Init | `[##################------]` 387 / 508 (76.18%) | 1 | 120 |
| Game | `[##########--------------]` 1,999 / 4,799 (41.65%) | 0 | 2,800 |
...
The exact count is thirty-eight above the July snapshot. The higher percentage is still
primarily caused by the smaller C denominator; focused event-swap and debugger
passes have added forty exact functions after the restoration baseline. See
