...
The exact count is forty above the July snapshot. The higher percentage is still
primarily caused by the smaller C denominator; focused event-swap and debugger
passes have added forty-two exact functions after the restoration baseline. See
