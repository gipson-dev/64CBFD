...
The exact count is thirty-three above the July snapshot. The higher percentage is still
primarily caused by the smaller C denominator; focused event-swap and debugger
passes have added thirty-five exact functions after the restoration baseline. See
