...
| --- | ---: | ---: | ---: |
| Total | 2,595 / 5,484 (47.32%) | 1 | 2,888 |
| Init | 387 / 508 (76.18%) | 1 | 120 |
| Game | 2,027 / 4,795 (42.27%) | 0 | 2,768 |
...
denominator driven: the exact count is now 2,595, while
...
3. The original `func_150AD780`/`func_150AD78C` trig slice is restored, and
   ...
   and corrected pointer ABI, with no guarded rows. Continue with 28-word
   `func_15141564`, now the first eleven-difference row.
