...
denominator driven: the exact count is now 2,535, while
...
3. `func_1519C910` is byte-exact after guarded equality-operand
   normalization. Continue the genuine two-difference C queue at its smallest
   remaining body, `func_1517F448` (16 words).
