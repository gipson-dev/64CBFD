...
denominator driven: the exact count is now 2,536, while
...
3. `func_1517F448` is byte-exact after guarded address-calculation scheduling
   normalization. Continue the three remaining two-difference game bodies at
   `func_15079F6C` (20 words).
