...
| --- | ---: | ---: | ---: |
| Total | 2,644 / 5,483 (48.22%) | 1 | 2,838 |
| Init | 387 / 508 (76.18%) | 1 | 120 |
| Game | 2,076 / 4,794 (43.30%) | 0 | 2,718 |
...
denominator driven: the exact count is now 2,644, while
...
3. The original `func_150AD780`/`func_150AD78C` trig slice is restored, and
   ...
   fifteen guarded FP scheduling words. Continue with 20-word
   `func_150C78E0` and its flag-gated high-half mask update.
