...
denominator driven: the exact count is now 2,537, while
...
3. `func_15079F6C` is byte-exact after relocation-preserving temporary-register
   normalization. Continue the two remaining two-difference game bodies at
   `func_1516968C` (20 words).
