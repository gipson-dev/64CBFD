...
| --- | ---: | ---: | ---: |
| Total | 2,601 / 5,484 (47.43%) | 1 | 2,882 |
| Init | 387 / 508 (76.18%) | 1 | 120 |
| Game | 2,033 / 4,795 (42.40%) | 0 | 2,762 |
...
denominator driven: the exact count is now 2,601, while
...
3. The original `func_150AD780`/`func_150AD78C` trig slice is restored, and
   ...
   comparison, and table-index expressions, with no guarded rows. Continue with
   46-word `func_1504BA38`, now the first twelve-difference game row.
