...
| --- | ---: | ---: | ---: |
| Total | 2,600 / 5,484 (47.41%) | 1 | 2,883 |
| Init | 387 / 508 (76.18%) | 1 | 120 |
| Game | 2,032 / 4,795 (42.38%) | 0 | 2,763 |
...
denominator driven: the exact count is now 2,600, while
...
3. The original `func_150AD780`/`func_150AD78C` trig slice is restored, and
   ...
   table-address words. Continue with 21-word `func_150337E4`, now the first
