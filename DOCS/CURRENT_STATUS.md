...
denominator driven: the exact count is now 2,542, while
...
the subsequent small game queue through `func_1514672C`.
...
3. The original `func_150AD780`/`func_150AD78C` trig slice is restored, and
   ...
   relocation-preserving load reorder. Continue the three-difference game
   queue at 36-word `func_15199980`.
