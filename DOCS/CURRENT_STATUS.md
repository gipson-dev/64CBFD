...
| --- | ---: | ---: | ---: |
| Total | 2,596 / 5,484 (47.34%) | 1 | 2,887 |
| Init | 387 / 508 (76.18%) | 1 | 120 |
| Game | 2,028 / 4,795 (42.29%) | 0 | 2,767 |
...
denominator driven: the exact count is now 2,596, while
...
3. The original `func_150AD780`/`func_150AD78C` trig slice is restored, and
   ...
   base-pointer local-slot words. Continue with 15-word `func_15178E14`, now
   the first eleven-difference row.
