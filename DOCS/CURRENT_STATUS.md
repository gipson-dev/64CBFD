...
| --- | ---: | ---: | ---: |
| Total | 2,602 / 5,484 (47.45%) | 1 | 2,881 |
| Init | 387 / 508 (76.18%) | 1 | 120 |
| Game | 2,034 / 4,795 (42.42%) | 0 | 2,761 |
...
denominator driven: the exact count is now 2,602, while
...
3. The original `func_150AD780`/`func_150AD78C` trig slice is restored, and
   ...
   lifetimes. Continue with 13-word `func_150882B0`, now the first
